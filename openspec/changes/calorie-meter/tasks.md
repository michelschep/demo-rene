...
- [ ] 6.1 Render loglijst gegroepeerd per maaltijdcategorie met naam en kcal per item
...
- [ ] 7.1 Voeg instellingen-icoon (⚙) toe aan de app; toon bij klik een overlay met dagdoel-invoerveld
- [ ] 7.2 Sla nieuw dagdoel op in `localStorage` en update ring en teller direct

## 8. Afronding & Stijl

- [ ] 8.1 Controleer alle kleuren op overeenkomst met Healthy House palet (salie groen, terracotta, warm wit)
- [ ] 8.2 Verifieer dat geen p5.js gereserveerde namen gebruikt worden als variabelen (`width`, `height`, `color`, etc.)
